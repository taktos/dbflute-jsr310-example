...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnNewAcceptableFlg = cci("NEW_ACCEPTABLE_FLG", "NEW_ACCEPTABLE_FLG", null, null, true, "newAcceptableFlg", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.jsr310.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.jsr310.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.jsr310.exbhv.ServiceRankBhv"; }
